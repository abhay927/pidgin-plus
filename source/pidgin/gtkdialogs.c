...
static const struct developer developers[] = {
	{"Renato Silva",                       NULL,                  "br.renatosilva@gmail.com"},
...
static const struct translator translators[] = {
	...
	{N_("Malay"),               "ms", "abuyop", "abuyop@gmail.com"},
...
static const struct translator past_translators[] = {
	...
	{N_("Malay"),               "ms", "Muhammad Najmi bin Ahmad Zabidi", NULL},
...
/* Note: Frees 'string' */
static GtkWidget *
pidgin_build_help_dialog(const char *title, const char *role, GString *string, gint width, gint height)
{
...
void pidgin_dialogs_about(void)
{
	...
	about = pidgin_build_help_dialog(tmp, "about", str, 0, 630);
...
void pidgin_dialogs_plugins_info(void)
{
	...
	plugins_info = pidgin_build_help_dialog(title, "plugins_info", str, 0, 0);
